...
namespace NaughtyDogDCReader
{
    ...
    public class PropertyButton : System.Windows.Forms.Button
    {
        ...
        private DCModule.DCEntry _dcProperty;
    }
    ...
    public class SIDBase
    {
        ...
        private SIDBase(string SIDBasePath)
        {
...
#pragma warning disable IDE0011 // aDd BrAcEs
        ...
        public static void LoadSIDBase(string SIDBasePath)
        {
            ...
            {
                // Bitch 'n moan
                Echo($"Provided {nameof(SIDBasePath)} wasn't valid (file doesn't exist).\nPath: " + SIDBasePath);
            }
        }
        ...
        {
            var id = "(NO_SIDBASE_LOADED)";

            foreach (var table in SIDBases ?? Array.Empty<SIDBase>())
            {
                id = table?.LookupSIDHash(EncodedSID) ?? "(NULL_SID_BASE)";
